...
const Functionalities = () => {
  return (
    <>
      <div id="funcionalidades" className={style.container}>
        <div className={style.content}>
          <h6>Funcionalidades</h6>
          <h2>Acesso on-line rápido e simples</h2>
          <p>
            Acesse do seu celular ou computador não perca mais tempo montando
            relatórios
          </p>
        </div>
        <div className={style.content}>
          <div className={style.card}>
            ...
            <p>
              Lista de consumo dos veículos. Filtro por período. Totalmente
              integrado via API.
            </p>
          </div>
          <div className={style.card}>
            ...
            <p>
              Atualização em tempo real de todos Veículos, Motoristas e Alertas
            </p>
          </div>
          <div className={style.card}>
